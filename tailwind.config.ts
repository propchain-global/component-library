        ...
        extend: {
            ...
            colors: {
                ...
                button: {
                    secondary: {
                        icon: {
                            default: 'var(--button-secondary-icon-default)',
                            hover: 'var(--button-secondary-icon-hover)',
            ...
            backgroundColor: {
                ...
                'button-secondary': {
                    disabled: 'var(--button-secondary-accent-bg-disabled)',
                    active: 'var(--button-secondary-accent-bg-active)',
                    hover: 'var(--button-secondary-accent-bg-hover)',
                    default: 'var(--button-secondary-accent-bg-default)',
                },
                'button-white': {
            ...
            textColor: {
                ...
                'button-secondary': {
                    disabled: 'var(--button-secondary-accent-text-disabled)',
                    active: 'var(--button-secondary-accent-text-active)',
                    hover: 'var(--button-secondary-accent-text-hover)',
                    default: 'var(--button-secondary-accent-text-default)',
                },
                'button-white': {
                ...
                'currency-field': {
                    ...
                    disabled: 'var(--currency-field-text-disabled)',
            ...
            borderColor: {
                ...
                'button-secondary': {
                    disabled: 'var(--button-secondary-accent-border-disabled)',
                    active: 'var(--button-secondary-accent-border-active)',
                    hover: 'var(--button-secondary-accent-border-hover)',
                    default: 'var(--button-secondary-accent-border-default)',
                },
                'button-white': {
            ...
            borderRadius: {
                ...
                'Button-s': 'var(--button-s-corner-radius)',
                'Button-m': 'var(--button-m-corner-radius)',
                'Button-l': 'var(--button-l-corner-radius)',
                'Button-xl': 'var(--button-xl-corner-radius)',
                Alert: cornerRadius.m,
                'currency-field-radius': 'var(--currency-field-border-radius)',
            ...
            borderWidth: {
                ...
                'button-s': 'var(--button-s-border-width)',
                'button-m': 'var(--button-m-border-width)',
                'button-l': 'var(--button-l-border-width)',
                'button-xl': 'var(--button-xl-border-width)',
                'currency-field-border': 'var(--currency-field-border-width)',
            },
            ...
            height: {
                ...
                'Pills-s': 'var(--pill-height-s)        ',
                'Pills-l': 'var(--pill-height-l)',
            ...
            padding: {
                ...
                'Button-s': 'var(--button-s-padding-left)',
